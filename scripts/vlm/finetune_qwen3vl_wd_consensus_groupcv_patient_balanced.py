#!/usr/bin/env python
"""
Qwen3-VL WD_P consensus-only patient-grouped cross-validation — patient-balanced sampling
=============================================================
...
from vlm import finetune_qwen3vl_wd_consensus_binary_patient_balanced as exp
...
def main():
    ...
    print(
        "QWEN3-VL WD_P CONSENSUS PATIENT-GROUPED CV — PATIENT-BALANCED SAMPLING"
    )
    print("=" * 72)
    ...
    print("Training sampler: inverse patient-frequency, with replacement")
    print(
