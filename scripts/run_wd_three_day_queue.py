...
from wd_presentation_common import exclusive_lock,load_folds
...
def main(args):
    ...
    commands=[('tfidf',[sys.executable,str(scripts/'run_wd_tfidf_baselines.py'),'--master-root',str(master),'--output',str(root/'baselines')]),
