#!/usr/bin/env python
"""
Qwen3-VL WD_P consensus-only patient-grouped cross-validation — 3-epoch lower-LR experiment
=============================================================
...
- Lower learning rates: LoRA 2e-5, classifier head 5e-5
...
import finetune_qwen3vl_wd_consensus_binary as exp
...
def main():
    ...
    print(
        "QWEN3-VL WD_P CONSENSUS PATIENT-GROUPED CV — 3 EPOCHS, LOWER LR"
    )
    print("=" * 72)
    ...
    print(
        "Experiment intent: test whether lower learning rates allow useful "
        "multi-epoch training without the validation degradation seen at 5e-5/1e-4."
    )
    print(
